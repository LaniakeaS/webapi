 ...
 * LU ID: 34648127<br>
 */
@WebServlet(urlPatterns = {"/user/logoff"})
public class LogoffAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            TestDatabaseAPI.runModify("update customer set is_status = 1 where login_name = \"" + accountName +
                    "\";");

            Daemon.users.remove(accountName, user);
            out.println("{");
